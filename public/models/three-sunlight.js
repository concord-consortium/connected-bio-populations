    ...
    setupDialogs: function() {
      ...
      onTopOfSomeone = (function(_this) {
        return function(x1, y1) {
          var j, len, otherAgent, ref, x2, y2;
      ...
      makeSeeds = (function(_this) {
        return function(agent) {
          ...
          while (_this.env.agents.length < 7) {
            ...
            results.push(setLocation(agent, child));
          }
          return results;
        };
      })(this);
      ...
      return Events.addEventListener(Environment.EVENTS.STEP, (function(_this) {
        return function() {
          var agent, agents, firstAgent, j, len, results, season;
          agents = _this.env.agents;
          if (agents.length > 0) {
          ...
          if (waitingForMessage4) {
            ...
            if (message4StepCount === 16) {
              ...
              for (j = 0, len = agents.length; j < len; j++) {
                agent = agents[j];
                results.push(agent.set("complete", true));
              }
              return results;
            }
          }
